...
import haircare from "../assets/projects/haircare.PNG";
import tradxsellvideo from "../assets/videos/tradxsell.mp4";
import teskhavideo from "../assets/videos/teskha.mkv";
import bizzkonnvideo from "../assets/videos/bizzkonn.mp4";
import lunacarevideo from "../assets/videos/lunacare.mp4";
import ansabgullvideo from "../assets/videos/ansabgull.mkv";
import bonitavideo from "../assets/videos/bonita.mp4";
import accobeesvideo from "../assets/videos/accobees.mp4";
import sixthledgervideo from "../assets/videos/sixthledger.mp4";
import haircarevideo from "../assets/videos/haircare.mp4";
...
const projects = [
  ...
  },
  {
    ...
    title: "Sixth Ledger",
    description:
      "At Sixth Ledger, we combine expertise and advanced tools like QuickBooks and Xero to deliver comprehensive financial services.",
    longDescription:
      "At Sixth Ledger, we combine expertise and advanced tools like QuickBooks and Xero to deliver comprehensive financial services.<br></br>With professional services like budgeting and forecasting, year-end financial statements, and strategic competitor analysis, we empower startups and established enterprises alike to thrive in a competitive market. Led by a team of experienced ACCA Affiliates in Pakistan, we prioritize accuracy, compliance, and efficiency. Partner with us for tailored financial solutions, ensuring clarity and success every step of the way.",
    image: sixthledger,
    video: sixthledgervideo,
    client: "Sixth Ledger",
    duration: "1 months",
    technologies: ["React", "Node", "Express", "Mongodb"],
  ...
  {
    id: 11,
    title: "0000 Hair Care",
    description:
      "0000 haircare stands as a brand that seamlessly combines performance and holistic innovation, making our shampoos, conditioners",
    longDescription:
      "0000 haircare stands as a brand that seamlessly combines performance and holistic innovation, making our shampoos, conditioners and styling products the perfect choice for those who seek stunning hair and a commitment to eco-consciousness.<br></br>We are a team of passionate hairdressers that are now based in Asia, with many years of diverse experience in the global hairdressing industry.Driven by the Japanese philosophy of “Kaizen” which embodies the concept of continuous progression and improvement.",
    image: haircare,
    video: haircarevideo,
    client: "0000 Hair Care",
    duration: "1 months",
    technologies: ["Shopify"],
    link: "https://0000haircare.com/",
  },
];
